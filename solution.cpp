...
{
    xrp::Source* s = xrp::FiniteSource::create_source(xru::Vector3D(0,-100,0), xru::Vector3D(0, 1, 0), xru::Vector3D(0, 0, 1), 0.1, 0.2, xrc::KVP_60_1AL);
...
*/
    ...
    scene->detector_->save_to_file("../HELPERS/ELLIPSOID.txt");
